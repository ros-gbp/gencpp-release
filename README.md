## gencpp (noetic) - 0.7.2-1

The packages in the `gencpp` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic gencpp` on `Fri, 25 Apr 2025 23:42:13 -0000`
